...
^5::
    BoardBackup := ClipboardAll
    Clipboard := "Heyo fellow clan mates :wave:, Just wanted to point your focus to our discord server where we generally do everything there like clan events, giveaways (freeplat-nitro), squad recruiting and the usual clan interaction with members. Don't miss it out https://discord.gg/GladsLegion :council: "
    Send, ^v
    Sleep, 10
    Send, {enter}
    Clipboard := BoardBackup
...
^6::
    BoardBackup := ClipboardAll
    Clipboard := ":council: Discord Link: https://discord.gg/GladsLegion :council:"
    Send, ^v
    Sleep, 10
    Send, {enter}
    Clipboard := BoardBackup
...
^7::
    BoardBackup := ClipboardAll
    Clipboard := ":council: The Staff team is currently looking for Head Gladiators! Heads are primarily recruiters, chat mods and community leaders. Discord mandatory! Contact an online Head/Supreme in game/Discord if you are interested. Discord Link: https://discord.gg/GladsLegion :moon:"
    Send, ^v
    Sleep, 10
    Send, {enter}
    Clipboard := BoardBackup
